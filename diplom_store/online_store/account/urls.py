...
from account.views import AccountUser, RegisterView, MyLoginView, MyLogoutView, UserProfileView, UserAvatarView, UserPasswordChangeView, HistoryOrder, ProfileView
